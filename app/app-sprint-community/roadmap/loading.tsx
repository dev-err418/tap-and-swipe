    ...
    <div className="pt-8">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {Array.from({ length: 9 }).map((_, i) => (
          ...
          >
            <div className="mb-4">
              <div className="h-8 w-8 rounded-lg bg-black/[0.04] animate-pulse" />
            </div>
            <div className="mb-2 h-5 w-32 rounded-lg bg-black/[0.04] animate-pulse" />
            <div className="mb-3 h-2 w-full rounded-full bg-black/10 animate-pulse" />
            <div className="flex items-center justify-between">
              <div className="h-4 w-24 rounded-lg bg-black/[0.04] animate-pulse" />
              <div className="h-4 w-4 rounded bg-black/[0.04] animate-pulse" />
            </div>
          </div>
        ))}
      </div>
