        ...
        <div className="rounded-xl bg-black/[0.03] p-6">
          <Dialog>
            <DialogTrigger asChild>
              <button className="inline-flex items-center gap-2 rounded-full bg-black px-5 py-2.5 text-sm font-medium text-white hover:bg-black/85 transition-colors cursor-pointer">
