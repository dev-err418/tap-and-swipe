# Terms of use for NetPay

**Last Updated:** March 13, 2026

## 1. Acceptance of terms

These Terms of Use ("Terms") constitute a legally binding agreement between you and Arthur ("we", "us", "our", or "Developer") regarding your use of the NetPay mobile application ("App"). By downloading, installing, accessing, or using the App, you agree to be bound by these Terms. If you do not agree to these Terms, do not use the App.

## 2. Description of service

NetPay is a mobile application that provides:

- Paycheck and take-home pay calculation based on salary or hourly rate
- Federal and state income tax estimation for all 50 US states
- FICA, Social Security, and Medicare deduction breakdowns
- Pre-tax deduction modeling (401k, HSA, FSA, health insurance)
- Side-by-side scenario comparison for job offers and raises
- Hourly vs salary comparison mode
...
All paycheck calculations, saved scenarios, and preferences are stored locally on your device. We do not operate a backend server and have no access to your personal data.
...
"NetPay" and associated logos are trademarks of the Developer. You may not use these trademarks without prior written permission.

## 8. Financial disclaimer

### 8.1 Not financial advice

THE APP IS A CONVENIENCE TOOL FOR ESTIMATING PAYCHECK AND TAKE-HOME PAY AMOUNTS. It does not provide financial, tax, or legal advice. The calculations provided are estimates based solely on the information you enter and general tax rules. They are not a substitute for professional tax advice.

### 8.2 Accuracy

While we strive for accurate calculations, tax laws and rates change frequently and vary by jurisdiction. You are responsible for verifying all amounts with your employer's payroll department or a qualified tax professional. We are not liable for any errors in calculation resulting from incorrect input, outdated tax data, or software bugs.
