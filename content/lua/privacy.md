# Privacy policy for Lua

**Last Updated:** November 4, 2025

## Introduction

This Privacy Policy describes how Lua ("we", "us", or "our") collects, uses, and shares information when you use our mobile application (the "App"). We are committed to protecting your privacy and being transparent about our data practices.
...
- **Basic profile information**: Name (optional), due date, and pregnancy-related preferences
- **Tracking preferences**: Features you're interested in (kick counter, contraction timer, weight tracking, etc.)
- **Notification preferences**: Whether you enable notifications, frequency, and preferred time windows
...
- **Conversion tracking data**: Device identifiers (IDFA on iOS when permission is granted) and app events collected through TikTok Pixel for advertising measurement
...
- Pregnancy tracking data (kick counts, contractions, weight logs)
- Your due date and weekly progress
...
1. **Service delivery**: To provide you with personalized pregnancy tracking and weekly updates based on your preferences
...
5. **Communication**: To send you important updates about the app (if you've opted in)
...
- **Analytics data**: Analytics data is retained according to our third-party providers' policies (typically 90 days to 2 years).
...
- **Opt-out of tracking**: iOS users can opt out of TikTok conversion tracking and other advertising tracking through App Tracking Transparency (ATT) settings (Settings > Privacy & Security > Tracking)
...
The app uses local push notifications to deliver pregnancy updates and reminders based on your preferences. These notifications are:
...
By using Lua, you acknowledge that you have read and understood this Privacy Policy and agree to the collection, use, and sharing of your information as described herein.
