# Terms of use for Versy

**Last Updated:** October 4, 2025

## 1. Acceptance of terms

These Terms of Use ("Terms") constitute a legally binding agreement between you and Arthur ("we", "us", "our", or "Developer") regarding your use of the Versy mobile application ("App"). By downloading, installing, accessing, or using the App, you agree to be bound by these Terms. If you do not agree to these Terms, do not use the App.

## 2. Description of service

Versy is a mobile application that provides:

- Daily Bible verses and scripture quotes
- Prayer reminders and customizable notification schedules
- Streak tracking for daily devotional engagement
- Category-based content personalization (faith, hope, love, strength, etc.)
...
You retain all rights to any content you create within the App (such as personal prayers or notes). By using the App, you grant us a license to use, store, and process your data as described in our Privacy Policy. We will handle your data in accordance with applicable privacy laws.
...
Bible verses and scripture content in the App are sourced from public domain Bible translations. We respect intellectual property rights and expect users to do the same.

### 7.3 User-generated content

You retain full ownership of personal prayers or notes you create. Custom content is stored locally on your device and is not transmitted to or accessed by us.

### 7.4 Trademarks

"Versy" and associated logos are trademarks of the Developer. You may not use these trademarks without prior written permission.

## 8. Spiritual disclaimer

### 8.1 Not professional advice

THE APP IS NOT INTENDED TO PROVIDE PROFESSIONAL RELIGIOUS COUNSELING OR THERAPEUTIC ADVICE. The Bible verses and prayers provided are for spiritual encouragement and personal devotion only and should not be considered a substitute for professional pastoral counseling, medical, or mental health advice.
