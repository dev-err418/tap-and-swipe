...
These Terms of Service ("Terms") constitute a legally binding agreement between you and Tap & Swipe ("we", "us", "our") regarding your use of App Sprint ASO ("App"). By purchasing, downloading, installing, or using the App, you agree to be bound by these Terms. If you do not agree, do not use the App.

## 2. Description of Service

App Sprint ASO is a macOS desktop application that provides:

- Keyword research and difficulty/popularity analysis for Apple App Store
- App Store metadata editing via App Store Connect integration
- Apple Search Ads campaign management and optimization
- Competitor tracking and market analysis

The App relies on Apple's publicly available and authenticated APIs. Features may vary depending on your App Store Connect access and Apple Search Ads account status.

## 3. Eligibility

You must be at least 18 years of age to use this App. By using the App, you represent and warrant that you meet this age requirement and have the legal capacity to enter into these Terms.

## 4. Account & License

### 4.1 License Grant

Subject to your compliance with these Terms and payment of applicable fees, we grant you a limited, non-exclusive, non-transferable, non-sublicensable, revocable license to install and use the App on a single computer you own or control, solely for your personal or internal business use.

### 4.2 Device Binding

Your license key is bound to a single computer upon first activation using a machine identifier. You may not use the same license on multiple computers simultaneously. If you need to transfer your license to a new computer, contact us and an administrator can reset your device binding.

### 4.3 Restrictions

You agree NOT to:

- Use the App on more than one computer per license
- Share, resell, sublicense, or transfer your license key to another person
- Modify, reverse engineer, decompile, or disassemble the App
- Redistribute or make the App available to third parties
...
- Use automated tools to abuse or overload the App's API connections
- Attempt to access other users' license keys or data
...
- Warranties regarding accuracy or completeness of App Store data or keyword metrics
...
Subject to Section 12.1, our total liability to you for all claims arising out of or relating to these Terms or your use of the App shall not exceed the total amount you paid to us in the twelve (12) months preceding the claim.

### 12.3 Exclusion of Damages

Subject to Section 12.1, we shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of profits, revenue, data, or business opportunities, even if we have been advised of the possibility of such damages.
...
We may revise these Terms from time to time. We will provide at least 30 days' notice of material changes via email or through the App. Your continued use of the App after changes become effective constitutes acceptance of the revised Terms.
